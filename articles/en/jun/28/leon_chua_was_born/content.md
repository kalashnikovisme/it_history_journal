...
sources:
  - title: "Leon Chua's homepage — UC Berkeley"
  ...
  - title: "Scholarpedia: Chua's Circuit"
...
- [Leon Chua's homepage at the University of California, Berkeley](https://people.eecs.berkeley.edu/~chua/)
- [*Memristor — The Missing Circuit Element* (IEEE, 1971)](https://ieeexplore.ieee.org/document/1083337)
- [Chua's Circuit reference collection](https://people.eecs.berkeley.edu/~chua/circuitrefs.html)
- [Scholarpedia: *Chua's Circuit*](http://www.scholarpedia.org/article/Chua_circuit)
- [*Cellular Neural Networks: Theory*](https://nonlinear.eecs.berkeley.edu/raptor/CNNs/CellularNeuralNetworks-Theory.pdf)
- [Leon Chua's Google Scholar profile](https://scholar.google.com/citations?user=NkGL8bgAAAAJ)
