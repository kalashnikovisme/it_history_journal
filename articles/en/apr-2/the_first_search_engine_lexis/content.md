...
The principles of working with Lexis were the following:

writing a query on a paper that will be sent to Lexis

checking this query by several specialists

then they connected to Lexis and entered the query very quickly so as not to waste time
...
LexisNexis website https://www.lexisnexis.com/
