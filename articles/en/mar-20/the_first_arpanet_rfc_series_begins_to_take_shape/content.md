...
On March 20, 1970, a small set of documents appeared that would later become part of the foundation of the modern Internet: RFC 36 (March 16), RFC 37, RFC 38, and RFC 39. These were part of the early Request for Comments (RFC) series — an experiment in open collaboration that changed how protocols are designed forever.
...
At this stage, even basic things were still unclear:

how machines should talk to each other

how to structure messages

how to manage connections

These RFCs show that nothing was “obvious” yet.
...
This process became one of the most important traditions in computing.

Even today, the RFC system is still used by organizations like the Internet Engineering Task Force (IETF).

The most interesting part
What stands out when you read these early RFCs is how human they are.

They include:

informal language

direct responses to other engineers
...
Interesting links
Early RFC archive — https://www.rfc-editor.org/rfc-index.html
...
ARPANET history overview — https://www.computerhistory.org/internethistory/

Original RFC notes (scan) — https://datatracker.ietf.org/doc/rfc1/
