...
Before Twitter, most online communication was either long-form (blogs, forums) or private (emails, instant messaging).

Twitter introduced something in between:
...
In 2007, during the South by Southwest (SXSW) conference, Twitter usage exploded. People used it to coordinate, share updates, and follow what was happening in real time.
...
That first tweet is important not because of its content, but because of what it started.
...
Links and materials
Original tweet (archived): https://twitter.com/jack/status/20
