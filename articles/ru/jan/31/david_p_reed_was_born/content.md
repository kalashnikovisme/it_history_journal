...
date: "31 января 1952"
excerpt: "Дэвид Рид создал UDP и настоял на разделении TCP и IP — два архитектурных решения, благодаря которым интернет масштабируется до миллиардов пользователей и позволяет смотреть видео в реальном времени."
---
