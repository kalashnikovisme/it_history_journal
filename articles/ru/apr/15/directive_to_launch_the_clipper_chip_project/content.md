...
title: "15 апреля 1993 — Начало проекта Clipper Chip и его историческое значение"
date: "15 апреля 1993"
excerpt: "Обзор событий 15 апреля 1993 года — запуска проекта Clipper Chip, его проблемы и влияние на криптографию и безопасность."
...
a public algorithm can be reviewed by the cryptographic community and independent professional organizations. Only after that, an algorithm is considered trustworthy
...
Skipjack remained secret during the early years of the Clipper Chip initiative, that's why did not inspire this confidence. In 1998, the algorithm was finally published, and independent researchers concluded that the algorithm itself was actually fairly strong.
